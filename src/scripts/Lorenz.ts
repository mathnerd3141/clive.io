...
const Lorenz = (selector : string) : { onclicktouch : (x: number, y: number) => void } => {
  ...
  //Color Range
  let color = d3.scalePow<string, number>()
  ...
  d3.interval(function(elapsedTime){spawnSprite(getRandomPoint());}, 1000);
